...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['BRO YOU ARE FUCKED', 0.2], //From 0% to 19%
		['Oh God', 0.4], //From 20% to 39%
		['Yikes', 0.5], //From 40% to 49%
		['Wombo', 0.6], //From 50% to 59%
		['Average', 0.69], //From 60% to 68%
		['Respect', 0.7], //69%
		['Pretty Good', 0.8], //From 70% to 79%
		['Brlliant!', 0.9], //From 80% to 89%
		['WE GOT THE SECRET FORMULA', 1], //From 90% to 99%
		['YOOOOOOOOOO', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
	...
	override public function create()
	{
		...
		botplayTxt = new FlxText(400, timeBarBG.y + 55, FlxG.width - 800, "BOTPLAY LMAO", 32);
