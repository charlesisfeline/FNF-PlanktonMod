...
function onCreate()
    makeLuaText('songText', songName .. " " .. currentDifficulty .. " - Plankton Engine (Psych 0.5.1)", 0, 2, 701);
...
function onUpdate(elapsed)
    ...
    setTextString('songText', songName .. " " .. currentDifficulty .. " - Plankton Engine (Psych 0.5.1)");
end